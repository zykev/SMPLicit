...
class Options():
    ...
    def initialize(self):
        ...
        # path_SMPLicit = '/disk/work/kyzhang/human/4dhuman-develop/SMPLicit/'
        ...
        self._parser.add_argument('--path_SMPL', type=str, default='SMPLicit/utils/neutral_smpl_with_cocoplus_reg.txt')
