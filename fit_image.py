...
for _file in files:
    ...
    path_smpl_prediction = _opt.smpl_prediction_folder + _file.replace('capture', 'mesh') + '_smpl.pkl'
    path_segmentation = _opt.cloth_segmentation_folder + _file.replace('capture', 'cloth') + '.png'
    path_instance_segmentation =  _opt.instance_segmentation_folder + _file.replace('capture', 'mask') + '.png'
